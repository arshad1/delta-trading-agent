...
class TradingAgent:
    ...
    def _build_system_prompt(self, assets) -> str:
        return (
            ...
            "3) Cooldown: After opening, adding, reducing, or flipping, impose a self-cooldown of "
            ...
            "edge (e.g., > ~0.25×ATR).\n"
            "5) Overbought/oversold ≠ reversal by itself: Treat RSI extremes as risk-of-pullback. "
            "You need structure + momentum confirmation to bet against trend.\n"
            "6) Prefer adjustments over exits: If the thesis weakens but is not invalidated, first "
