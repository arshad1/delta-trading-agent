...
CONFIG = {
    ...
    # ------------------------------------------------------------------ #
    # Which provider to use: anthropic | openai | deepseek | openrouter | openai_compat
    "llm_provider": _get_env("LLM_PROVIDER", "anthropic"),

    # Anthropic (default)
    "anthropic_api_key": _get_env("ANTHROPIC_API_KEY"),
    "llm_model": _get_env("LLM_MODEL", "claude-opus-4-5-20251101"),
    ...
    # Generic OpenAI-compatible endpoint (Ollama, LM Studio, vLLM, Groq, Together ...)
    "openai_compat_base_url": _get_env("OPENAI_COMPAT_BASE_URL", "http://localhost:11434/v1"),
    "openai_compat_api_key": _get_env("OPENAI_COMPAT_API_KEY", "none"),
    ...
    # Runtime controls                                                     #
    # ------------------------------------------------------------------ #
    "assets": _get_env("ASSETS"),  # e.g., "BTC ETH SOL"
